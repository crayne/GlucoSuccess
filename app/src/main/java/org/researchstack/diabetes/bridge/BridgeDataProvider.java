...
import org.researchstack.diabetes.bridge.body.ConsentSignatureBody;
import org.researchstack.diabetes.bridge.body.EmailBody;
import org.researchstack.diabetes.bridge.body.SharingOptionBody;
import org.researchstack.diabetes.bridge.body.SignInBody;
...
public abstract class BridgeDataProvider extends DataProvider
{
    ...
    public void uploadTaskResult(Context context, TaskResult taskResult)
    {
        ...
        {
            Log.i("GlucoSuccessDataProvidr", "uploadTaskResult() _ isTaskReminderEnabled() = true");
    ...
    {
        Log.i("GlucoSuccessDataProvidr", "scheduleReminderNotification()");
