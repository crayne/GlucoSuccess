...
public class GlucoSuccessPermissionResultManager extends PermissionRequestManager
{
    ...
    {
        if (permissionId.equals(GlucoSuccessApplication.PERMISSION_NOTIFICATIONS))
        {
    ...
    {
        // GlucoSuccessApplication.PERMISSION_NOTIFICATIONS is our non-system permission so we return true
        // if permissionId's are the same
        return permissionId.equals(GlucoSuccessApplication.PERMISSION_NOTIFICATIONS);
    }
